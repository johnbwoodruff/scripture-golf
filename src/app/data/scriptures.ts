...
export const SCRIPTURES: Scripture[] = [
  ...
  },
  {
    ...
    book: '1 Nephi',
    chapter: 2,
    verse: 'And my father dwelt in a tent.'
  },
  {
    volume: 'BOM',
    book: '1 Nephi',
  ...
  },
  {
    ...
    book: '2 Nephi',
    chapter: 5,
    verse: 'And it came to pass that we lived after the manner of happiness.'
  },
  {
    volume: 'BOM',
    book: '2 Nephi',
  ...
  },
  {
    ...
    book: '2 Nephi',
    chapter: 12,
    verse: `And it shall come to pass in the last days, when the mountain of the Lord's house shall be established in the top of the mountains, and shall be exalted above the hills, and all nations shall flow unto it.`
  },
  {
    volume: 'BOM',
    book: '2 Nephi',
  ...
  },
  {
    ...
    book: 'Jacob',
    chapter: 6,
    verse: 'O be wise; what can I say more?'
  },
  {
    volume: 'BOM',
    book: 'Jacob',
  ...
  },
  {
    ...
    book: 'Mosiah',
    chapter: 18,
    verse: `And it came to pass that he said unto them: Behold, here are the waters of Mormon (for thus were they called) and now, as ye are desirous to come into the fold of God, and to be called his people, and are willing to bear one another's burdens, that they may be light;`
  },
  {
    volume: 'BOM',
    book: 'Mosiah',
  ...
  },
  {
    ...
    book: 'Alma',
    chapter: 18,
    verse: `And they answered the king, and said: Whether he be the Great Spirit or a man, we know not; but this much we do know, that he cannot be slain by the enemies of the king; neither can they scatter the king's flocks when he is with us, because of his expertness and great strength; therefore, we know that he is a friend to the king. And now, O king, we do not believe that a man has such great power, for we know he cannot be slain.`
  },
  {
    volume: 'BOM',
    book: 'Alma',
  ...
  },
  {
    ...
    book: 'Alma',
    chapter: 22,
    verse: `And it came to pass that he went in unto him into the king's palace, with his brethren, and bowed himself before the king, and said unto him: Behold, O king, we are the brethren of Ammon, whom thou hast delivered out of prison.`
  },
  {
    volume: 'BOM',
    book: 'Alma',
  ...
  },
  {
    ...
    book: 'Alma',
    chapter: 24,
    verse: `And this they did, it being in their view a testimony to God, and also to men, that they never would use weapons again for the shedding of man's blood; and this they did, vouching and covenanting with God, that rather than shed the blood of their brethren they would give up their own lives; and rather than take away from a brother they would give unto him; and rather than spend their days in idleness they would labor abundantly with their hands.`
  },
  {
    volume: 'BOM',
    book: 'Alma',
  ...
  },
  {
    ...
    book: '3 Nephi',
    chapter: 27,
    verse: `And how be it my church save it be called in my name? For if a church be called in Moses' name then it be Moses' church; or if it be called in the name of a man then it be the church of a man; but if it be called in my name then it is my church, if it so be that they are built upon my gospel.`
  },
  {
    volume: 'BOM',
    book: '3 Nephi',
    chapter: 28,
    verse: 'And thrice they were cast into a furnace and received no harm.'
  },
  {
    volume: 'BOM',
    book: '3 Nephi',
